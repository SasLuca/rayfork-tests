...
void on_init(void)
{
    ...
    npatch_texture = rf_load_texture_from_file("../../../examples/assets/ninepatch_button.png", RF_DEFAULT_ALLOCATOR, RF_DEFAULT_IO);
}
...
void on_frame(const input_data input)
{
    ...
    rf_draw_texture(npatch_texture,(rf_vec2){ 10, 93 }, 0.0f, 1.0f, RF_WHITE);
