...
//    rf_init_audio_device();
    ...
    button = rf_load_texture_from_file("../../../examples/assets/button.png", RF_DEFAULT_ALLOCATOR, RF_DEFAULT_IO); // Load button texture
...
void on_frame(const input_data input)
{
    ...
    {
        if (input.mouse_left_down) btnState = 2;
        else btnState = 1;
...
//        rf_play_sound(fx_button);
    ...
    rf_begin();
        ...
        rf_draw_texture(button, sourceRec, (Vector2){ btnBounds.x, btnBounds.y }, WHITE); // Draw button frame
