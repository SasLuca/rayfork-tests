...
void on_init(void)
{
    ...
    background = rf_load_texture_from_file("../../../rayfork-examples/examples/assets/cyberpunk_street_background.png", RF_DEFAULT_ALLOCATOR, RF_DEFAULT_IO);
    midground = rf_load_texture_from_file("../../../rayfork-examples/assets/cyberpunk_street_midground.png", RF_DEFAULT_ALLOCATOR, RF_DEFAULT_IO);
    foreground = rf_load_texture_from_file("../../../rayfork-examples/assets/cyberpunk_street_foreground.png", RF_DEFAULT_ALLOCATOR, RF_DEFAULT_IO);
}
